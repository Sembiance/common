// From: http://www.thingiverse.com/thing:7896/#files
module egg(radius, stretch, angle, slice=0) 
{
	intersection()
	{
		translate([0,0,stretch*radius])
		{
			cube(2*stretch*radius, center = true);
		}
		translate([0,0,get_offset(angle)*radius])
		{
			rotate([angle,0,0])
			{
				union()
